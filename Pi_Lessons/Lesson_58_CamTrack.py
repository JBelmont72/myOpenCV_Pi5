'''
Simple control algorithm for a pan tilt  camera to track an Object of Interest in OpenCV. We train the device to recognize an Object of Interest based on color, and then the camera is adjusted to keep the object in the center of the frame as the device moves.
2 programs, second with comments
'''
# import cv2. # program 1 
