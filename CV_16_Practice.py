...
myFace=FR.load_image_file('/Users/judsonbelmont/Documents/Projects/OpenCV_1/demoImages/known/Judson Belmont.jpg')
faceLoc=FR.face_locations(myFace)[0]
myFaceEncode=FR.face_encodings(myFace)[0]
...
knownEncodings=[donFaceEncode,nancyFaceEncode,penceFaceEncode,myFaceEncode]
names=['Donald Trump','Nancy Pelosi','Mike Pence','Judson Belmont']
